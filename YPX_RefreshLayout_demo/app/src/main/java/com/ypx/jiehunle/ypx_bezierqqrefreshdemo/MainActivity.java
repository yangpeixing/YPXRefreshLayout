...
public class MainActivity extends FragmentActivity {
	...
	private NetEaseIndicator mIndicator2;
	...
	protected void setStyle() {
		...
		mIndicator2.setDefaultHeight(dp(30));//设置默认高度为30dp
		mIndicator2.setTabPadding(dp(10), 0, dp(10), dp(0));//设置tabPadding左右10dp
		mIndicator2.setBackgroundRadius(dp(35));//设置外框半径25dp
		mIndicator2.setShowTabSizeChange(true);//显示字体大小切换效果
		mIndicator2.setShowBackground(false);//不显示背景
		mIndicator2.setShowIndicator(false);//显示指示器
		mIndicator2.setDeuceTabWidth(false);//不平分tab宽度，默认为平分
		mIndicator2.setTabTextSize(13);//设置tab默认字体大小
		mIndicator2.setTabMaxTextSize(15);//设置tab变换字体大小，如果setShowTabSizeChange设置false，则按默认字体大小
		...
		mIndicator2.setBackgroundStrokeWidth(dp(1));//设置背景框宽度\
